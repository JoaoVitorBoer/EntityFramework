        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Administrador>(entity =>
            {
                ...
                entity.HasOne(d => d.CodAdministradorNavigation)
                    ...
                    .HasForeignKey<Administrador>(d => d.CodAdministrador)
            ...
            modelBuilder.Entity<Autor>(entity =>
            {
                ...
                entity.HasMany(d => d.CodProdutos)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        r => r.HasOne<Autor>().WithMany().HasForeignKey("CodAutor").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_AUT_AUTPROD"),
                        j =>
                        {
